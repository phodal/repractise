include_dir=build
source=chapters/prelude.md chapters/frontend.md chapters/mvc.md chapters/backend.md chapters/dev-ops.md chapters/refactor-basic.md chapters/refactor-cms.md chapters/basis-github-cms.md chapters/a-arch.md chapters/message.md chapters/readable.md chapters/patterns.md chapters/build.md chapters/cd.md chapters/time.md chapters/impact.md chapters/intership.md chapters/addional.md
title='RePractise'
filename='repractise'
