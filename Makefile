include_dir=build
source=chapters/prelude.md chapters/frontend.md chapters/backend.md chapters/readable.md chapters/refactor-basic.md chapters/refactor-cms.md chapters/a-arch.md chapters/message.md chapters/patterns.md chapters/model.md chapters/thinking.md 
title='RePractise'
filename='repractise'
