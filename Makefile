include_dir=build
source=chapters/prelude.md chapters/frontend.md chapters/backend.md chapters/front-back-end.md chapters/no-stacks.md chapters/refactor-basic.md chapters/refactor-cms.md chapters/a-arch.md chapters/patterns.md chapters/model.md chapters/domain.md chapters/thinking.md
title='RePractise'
filename='repractise'
